...
public class Dao {
    ...
    private Dao() {
        ...
        this.usuarios.put("leo", new Usuario("leo", "202cb962ac59075b964b07152d234b70", "leozin", null, 12345));
        this.usuarios.put("ruan", new Usuario("ruan", "202cb962ac59075b964b07152d234b70", "ruanzada", null, 12345));
